...
#
# NOTE: the draft's translation of this article omits the EN source's
# "Humble Inquiry cheat sheet" registration CTA paragraph (the one just
# after the bare YouTube URL) -- not included here, flagged for Russ
# rather than invented. The CAL-1/CAL-2 programme links and the related-
# webinar link carry over the EN source's own hrefs (external legacy
# betterchange-consulting.com URLs, unchanged by this translation) since
# the linked text itself is unchanged English/course-name text either
# way; the draft rendered these as plain names without markup, but
# dropping the working links looked like an unintended regression rather
# than a deliberate editorial choice.
...
bodyHtml: |-
  ...
  <p>Aufbauend auf Karl E. Weicks Sensemaking-Theorie und aktueller Führungsforschung bietet diese Session Einblicke in:</p>
  <ul>
  <li><strong>Sensemaking:</strong> Organisatorische Dynamiken verstehen und beeinflussen durch effektive Kommunikation und Vorbildverhalten.</li>
  <li><strong>Integrität:</strong> Vertrauen aufbauen, indem Handeln mit persönlichen Werten und Organisationszielen in Einklang gebracht wird.</li>
  <li><strong>Präsenz:</strong> Verbindung und Engagement fördern durch echtes Interesse und Small Talk.</li>
  <li><strong>Humble Inquiry:</strong> Die Machtdistanz verringern durch echte Neugier, die Praxis, eher zu fragen als zu erklären, und ein bewusstes Verlangsamen im Umgang mit Mitarbeitenden.</li>
  <li><strong>Authentizität:</strong> Einen persönlichen Führungsstil entwickeln, der beim Team ankommt und Erfolg vorantreibt.</li>
  </ul>
  <p><strong>Über den Vortragenden</strong></p>
  <p>Bent Myllerup, Fellow Coach bei Better Change, bringt über 20 Jahre Erfahrung als Führungskraft und Berater mit. Er hat zahlreichen Unternehmen geholfen, Komplexität zu navigieren, Führung zu entwickeln und ihre agilen Fähigkeiten zu stärken. Bent hat einen Master of Management Development der Copenhagen Business School und ist Mitgründer von Better Change.</p>

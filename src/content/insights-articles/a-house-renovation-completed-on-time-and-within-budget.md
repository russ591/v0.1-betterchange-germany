...
bodyHtml: |-
  ...
  <h2>The board as a coordination mechanism</h2>

  <p>As the weekend progressed, something else became clear: we were barely needed as coordinators. People were self-organising around the work. They could see what remained, identify where their skills were most useful, pull in help when a task required two pairs of hands, and mark things done without checking with us. The board was doing the coordination work.</p>

  <p>This removed the cognitive burden from us as "project owners" and distributed it across everyone involved. It also created something genuinely shared: a collective sense of ownership over the outcome. When the last sticky note moved to "Finished," it was everyone's achievement, not just ours.</p>

  <h2>The principle underneath the practice</h2>

  <p>This is what the Kanban Method looks like outside an office setting, and it demonstrates something important: the principles that make visual management powerful in software development and knowledge work apply equally anywhere there is complex, multi-person work that needs coordinating.</p>

  <p>Make the work visible. Give people what they need to be self-sufficient. Trust the system to do the coordination. Focus on finishing before starting. These are not complicated ideas. They are, in practice, remarkably effective ones.</p>

  <p>The house was completed on time and within budget. More importantly, the people who helped build it felt like they had genuinely built it. That outcome is harder to achieve than most renovation project plans account for.</p>
---

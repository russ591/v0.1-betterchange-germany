---
# name is reviewed, approved German copy (Phase B). tagline/description
# stay Phase A placeholder text marked "[DE]" until the training hub/
# course pages translation pass covers them -- see
# src/content/training-categories/de/scrum.md.
name: "Scaling"
tagline: "[DE] Apply agility across portfolios and large organisations"

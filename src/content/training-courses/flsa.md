...
languages:
  ...
  - German
whoIsThisFor:
  - Senior leaders and transformation sponsors designing organisation-wide agility at scale
  - Experienced Flight Levels coaches and consultants working on systemic agile transformation
  - Change executives responsible for large-scale operational or agile transformation programmes
  - Heads of PMO, strategy, and transformation in large or complex organisations
  - FL practitioners who have worked at FL2 or FL3 level and want a comprehensive architectural view
  - Anyone tasked with designing an agile operating model that spans multiple business areas
whatYoullLearn:
  - How to take a systemic view of an organisation and identify where interventions will have most impact
  - How to design a Flight Levels architecture that addresses all three levels simultaneously
  - How to sequence and prioritise transformation interventions without overwhelming the organisation
  - How to align an organisation's operating model with its strategic intent and delivery capability
  - How to build the leadership capability required for sustainable agile transformation
